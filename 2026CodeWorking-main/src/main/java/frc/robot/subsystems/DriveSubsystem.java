...
public class DriveSubsystem extends SubsystemBase {
  ...
  // my name is kevin yeah idk what im doing uh huh
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      // Rotation2d.fromDegrees(-AHRSJNI.c_AHRS_GetAngle()),
      // Rotation2d.fromDegrees(mImu.getDegrees),
      // mImu.getRotation2d(),
  ...
  public DriveSubsystem() {
    ...
    // m_rearRight.m_drivingSpark.setInverted(true);
    RobotConfig config;
    try {
      config = RobotConfig.fromGUISettings();
    } catch (Exception e) {
      throw new RuntimeException("Failed to load AutoBuilder configuration from GUI settings", e);
    }
  ...
  public double getHeading() {
    ...
    // return Rotation2d.fromDegrees(mImu.getAngle(IMUAxis.kZ)).getDegrees();
